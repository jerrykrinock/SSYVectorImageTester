...
+ (void)glyphOnPath:(NSBezierPath*)path
    ...
    NSFont* font = [NSFont fontWithName:@"Helvetica"
                                   size:100] ;
#else
    /* This will work in macOS 10.10 or 10.11, but in 10.12 you will get several
     horizontal bars/stripes instead of the expected glyph/character. */
    NSFont* font = [NSFont labelFontOfSize:100.0] ;
#endif
